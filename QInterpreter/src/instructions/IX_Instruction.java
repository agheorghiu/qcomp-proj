...
public class IX_Instruction implements Instruction {
	private String arg1, arg2;

	@Override
	public void execute(Flow f) throws Exception {
		Memory mem = VirtualMachine.getInstance().getMemory();
		TLOperator op = new TLOperator(new ComplexNumber(0, 0), 
				new ComplexNumber(1, 0), new ComplexNumber(1, 0), new ComplexNumber(0,0));
